...
func GetRandomCountriesExcept(exceptCountryCode string) []string {
	...
	rand.Shuffle(len(countriesExceptOne), func(i, j int) {
		countriesExceptOne[i], countriesExceptOne[j] = countriesExceptOne[j], countriesExceptOne[i]
	})
	return countriesExceptOne
}
...
func GetCountryCodeSymbol(x string) (string, error) {
	if len(x) != 2 {
